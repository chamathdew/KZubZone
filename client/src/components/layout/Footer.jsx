          ...
          <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
            <div className="space-y-5">
              <Link href="/" className="inline-flex items-center gap-3">
                ...
                <span className="text-2xl font-black uppercase tracking-wider bg-gradient-to-r from-brand-primary via-brand-secondary to-brand-accent bg-clip-text text-transparent">
