...
export default function SubtitleUploadModal({ isOpen, onClose, mediaId, mediaType, onUploadSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('/api/subtitles/upload', formData, {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="flex items-center justify-between mb-4 relative z-10">
          <h2 className="text-lg font-bold text-white">Upload Community Subtitle</h2>
        ...
        {success ? (
          <div className="flex flex-col items-center justify-center py-10 text-center relative z-10">
            ...
            <h3 className="text-base font-bold text-white mb-2">Upload Completed!</h3>
            <p className="text-xs text-slate-400 max-w-xs">
              Thank you for contributing! Your translation has been submitted and is currently in the moderation review queue.
            </p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 relative z-10 text-left">
            ...
            <div>
              ...
              <textarea
                placeholder="List release info or compatible video encoders (NF, Viki, HDRIP, etc.)"
                value={releaseNotes}
