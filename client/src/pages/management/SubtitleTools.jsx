...
export default function SubtitleTools() {
  ...
  const handleDownload = () => {
    const srtText = stringifySRT(processedSubs);
          ...
          <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4 pl-6">
                          <div>
                            ...
                            <input 
                              ...
                              className="w-full bg-luxury-950 border border-white/10 rounded-xl px-3 py-2 text-xs font-mono text-slate-300 outline-none"
                            />
                          </div>
                          <div>
            ...
            {activeTab === 'export' && processedSubs.length > 0 && (
              <div className="space-y-6">
                ...
                <div className="bg-luxury-900 border border-white/5 rounded-3xl overflow-hidden flex flex-col h-[450px]">
                  <div className="px-6 py-4 bg-white/5 border-b border-white/5 flex items-center justify-between">
                    <h4 className="text-xs font-black text-slate-300 uppercase tracking-widest flex items-center gap-1.5">
                      <Eye className="w-4 h-4 text-brand-primary" /> Live Subtitle Content Preview
                    </h4>
